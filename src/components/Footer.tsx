      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.about")}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/support" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.customerService")}</Link></li>
              <li>
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(t("footer.whatsappMessage"))}`}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            <h3 className="font-semibold text-foreground mb-4">{t("footer.owners")}</h3>
            <ul className="space-y-2">
              <li><Link to="/owner-dashboard" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.ownerPanel")}</Link></li>
              <li><Link to="/earnings-calculator" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.earningsCalculator")}</Link></li>
              <li><Link to="/availability-calendar" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.availabilityCalendar")}</Link></li>
              <li><Link to="/owner-guide" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.ownerGuide")}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/safety-guidelines" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.safetyGuidelines")}</Link></li>
              <li><Link to="/rental-agreement" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.rentalAgreement")}</Link></li>
              <li><Link to="/cancellation-policy" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.cancellationPolicy")}</Link></li>
              <li><Link to="/faq" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.faqFull")}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/terms" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.terms")}</Link></li>
              <li><Link to="/kvkk" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.kvkk")}</Link></li>
              <li><Link to="/cookie-policy" className="text-muted-foreground hover:text-foreground transition-colors text-sm">{t("footer.cookiePolicy")}</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-6 mb-6">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <span className="text-sm text-muted-foreground">{t("footer.securePaymentMethods")}</span>
        ...
        <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} RideYo. {t("footer.copyright")}</p>
        </div>
      </div>
    </footer>
  );
